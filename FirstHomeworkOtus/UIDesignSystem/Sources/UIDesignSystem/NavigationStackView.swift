...
public struct NavigationStackView<Content>:View where Content: View {
    ...
    @StateObject private var viewModel: NavigationStackViewModel = .init()
...
public struct NavPushButton<Content, Destination>: View where Content: View, Destination: View {
    ...
    @EnvironmentObject var viewMovel: NavigationStackViewModel
